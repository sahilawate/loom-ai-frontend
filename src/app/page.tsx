  ...
  return (
    <>
      ...
      <div style={{ 
        ...
        {/* Main Grid (Top 3: Customer Discovery & Checkout) */}
        <div style={{ 
          display: 'grid', 
          ...
          <LaunchCard href="/checkout" title="Checkout" desc="Manage your Cart" icon={<CartIcon />} />
        </div>

        {/* Secondary Grid (Bottom 3: Post-Purchase & Operations) */}
        <div style={{ 
          display: 'grid', 
          gridTemplateColumns: 'repeat(3, 1fr)',
          gap: '25px', 
          ...
          <LaunchCard href="/orders" title="My Orders" desc="Live order tracking timeline" icon={<OrderIcon />} />
          <LaunchCard href="/staff" title="Staff View" desc="Store associate dashboard" icon={<StoreIcon />} />
          <LaunchCard href="/agents" title="AI Agents" desc="View backend execution" icon={<PulseIcon />} />
        </div>
